...
Estudante de Engenharia de Software na UNINTER, me especializando em backend — e com um olho no Machine Learning pra onde quero chegar.

Gosto de entender não só *como* o código funciona, mas *por que* ele funciona. Isso me faz gostar de depurar, investigar comportamentos estranhos e pensar em arquitetura antes de sair escrevendo. Trabalho principalmente com Java, C# e Python.

Fora do código, sou curiosa, gosto de aprender coisas novas e não tenho medo de começar do zero em algo que não conheço ainda.
